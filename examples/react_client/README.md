...
This Vite/React application consumes the Rails example's real UI Message Stream
Protocol response with `@ai-sdk/react`'s `useChat`. There is no custom stream
parser or message-state reducer.
